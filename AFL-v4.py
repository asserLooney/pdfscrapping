...
def table1(path1,file1):
    try:
        ...
        # camelot.plot(tables1[2], kind='contour').show()
        # plt.show()
        Q1.put(tables1)
        ...
        for file in files:
            ...
            if file.lower().endswith('.pdf'):
                ...
                try:
                    ...
                    # tables.export('foo'+str(rw)+'.xlsx', f='excel')
                    # tables1.export('foo1'+str(rw)+'.xlsx', f='excel')
                    # camelot.plot(tables1[2],kind='contour').show()
                    # plt.show()
                    try:
...
# df4.to_excel(('first2'+'.xlsx'),index=False)   
wb.save(('results2.xlsx'))
df3=pd.read_excel('results2.xlsx',sheet_name='List', usecols=[16,17,18])
df4=pd.read_excel('results2.xlsx',sheet_name='List', usecols=[20,21,22])
